...
public class StringTutor {
	...
	/**
	 * Убедитесь, что приветствие greeting имеет вид Привет, Иван Иванов! или
	 * Привет,Петр Первый! т.е. начинается на Привет, заканчивается на ! и содержит
	 * 2 слова для имени и фамилии, причем имя и фамилия не короче 3 букв и
	...
	public boolean checkGreeting(String greeting) {
		...
		// }
		//
		// String name = greeting.substring(greeting.indexOf(',') + 1, greeting.length()
		// - 1).trim();
